            ...
            <jet-form-section @submitted="createUpdateEpisode">
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        />
                        <jet-input-error
                            :message="form.errors.google_podcast"
                            class="mt-2"
                        />
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        />
                        <jet-input-error
                            :message="form.errors.apple_podcast"
                            class="mt-2"
                        />
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <vue-tags-input
                            ...
                            @tags-changed="
                                (newTags) => (form.featured_hosts = newTags)
                            "
                        />
                        <jet-input-error
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <jet-input-error
                            :message="form.errors.is_popular"
                            class="mt-2"
                        />
                    </div>
                </template>
...
export default defineComponent({
    ...
    mounted() {
        if (this.episode) {
            ...
            this.form.tags = this.episode.tags ? this.episode.tags : [];
            this.form.featured_hosts = this.episode.featured_hosts ? this.episode.featured_hosts : [];
    ...
    methods: {
        createUpdateEpisode() {
            if (this.episode === undefined) {
                ...
                this.form.post(
                    route("episodes.update", { id: this.episode.id }),
                    {
                        errorBag: "createUpdateEpisode",
                        preserveScroll: true,
                    }
